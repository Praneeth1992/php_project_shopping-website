...
<body>
  <div  data-role="page" id="pageTwo">
    <div data-role="content" id="header">
      ...
      <img class="mainimg" style="width:300px;height:300px;"src="img/women_dresses3.jpg" />
...
<a href="cart.php" name="cart" class="ui-btn ui-btn-inline ui-corner-all">Go to Cart</a>
 ...
 <?php
      global $mysqli;
       $result = $mysqli->query("SELECT product_id,product_name,product_category,product_type,product_price,product_desc,image_desc,quantity FROM products WHERE product_id=219") or die($mysqli->error);
...
// $_SESSION['image_desc']=$row["image_desc"].'.jpg';
// $_SESSION['pro_name']=$row["product_name"];
// $_SESSION['pro_type']=$row["product_type"];
// $_SESSION['pro_desc']=$row["product_desc"];
// $_SESSION['pro_cat']=$row["product_category"];
// $_SESSION['pro_price']=$row["product_price"];
