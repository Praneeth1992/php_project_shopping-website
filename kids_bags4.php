...
<body>
  <div  data-role="page" id="pageTwo">
    <div data-role="content" id="header">
      ...
      <img class="mainimg" style="width:300px;height:300px;"src="img/kids_bags4.jpg" />
...
<a href="cart.php" name="cart" class="ui-btn ui-btn-inline ui-corner-all">Go to Cart</a>
 ...
 <?php
      global $mysqli;
       $result = $mysqli->query("SELECT product_id,product_name,product_category,product_type,product_price,product_desc,image_desc,quantity FROM products WHERE product_id=228") or die($mysqli->error);
